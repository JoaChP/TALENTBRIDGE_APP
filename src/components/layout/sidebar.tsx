...
const navItems = [
  ...
  { to: "/company-applications", icon: FileCheck, label: "Postulaciones", roleRequired: ["empresa", "admin"] },
  { to: "/applications", icon: FileCheck, label: "Mis Postulaciones", roleRequired: ["estudiante"] },
